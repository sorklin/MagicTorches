...
*/
    public static String colorize(String string) {
    	Server server = MagicTorches.get().getServer();					// Edit
    	if(server.getServerName().equalsIgnoreCase("craftbukkit"))				// Edit
            //if (((CraftServer)server).getReader().getTerminal().isANSISupported())	// Edit
