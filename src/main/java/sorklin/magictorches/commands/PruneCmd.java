...
public class PruneCmd extends GenericCmd {
    ...
    */
    ...
    public boolean execute() throws MissingOrIncorrectParametersException, InsufficientPermissionsException{
        ...
        Messaging.send(cs, "Removing all arrays in the db.");
        MagicTorches.getMiniDB().removeAll();
        
        Messaging.send("Saving active arrays.");
        MagicTorches.getMiniDB().saveAll(mt.mtHandler.getAllArrays());
